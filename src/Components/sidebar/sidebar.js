        ...
        <div className="sidebar bg-gray-700 w-[200] h-[400] mt-8">
            <div className="profile">
                ...
                <div className="resume ">
                    ...
                    <Link className="link" href="https://1drv.ms/w/c/25bf8b0d5643ec7c/EY8oD-upz5FIv_Dhd-lSUesBcPP0RpA-cHTn1BqlWCfZnw" target="_blank" rel="noopener noreferrer">Resume</Link>
